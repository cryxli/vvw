const cards = [
	...
	{name:'The Trebuchet', rarity:'legendary', points:3, attributes:['Mortar attacks are channeled quicker','The Fire Lake attack inflicts the <effect>Weakness</effect> condition.'], unique:true, requires:'Hand Mortar'},
	{name:'The Lightning', rarity:'legendary', points:3, attributes:['+20% damage vs <effect>Electrocuted</effect> foes.','-50% Ball Lightning cooldown','+50% Ball Lightning duration.'], unique:true, requires:'Lightning Gun'},
	{name:'The Thunderstorm', rarity:'legendary', points:2, attributes:['Lightning gun\'s basic attack is 50% longer'], unique:true, requires:'Lightning Gun'},
	{name:'The Gundslinger', rarity:'legendary', points:3, attributes:['Move faster and gain 20% chance to inflict <effect>Bleeding</effect> when using the Barrage attack.'], unique:true, requires:'Revolver'},
	...
	{name:'The Swashbuckler', rarity:'legendary', points:3, attributes:['Gain <effect>Quickness</effect> for 2 seconds when you kill an enemy with the rapier\'s Flurry attack','Coup de Grace causes <effect>Daze</effect> for 2 seconds on hit.'], unique:true, requires:'Rapier'},
	...
	{name:'The Blademaster', rarity:'legendary', points:3, attributes:['+20% critical damage with swords','Gain <effect>Regeneration</effect> for 10 seconds when you score a crit with a Sword Slash or Dash attack.'], unique:true, requires:'Sword'},
	...
	{name:'The Magician', rarity:'legendary', points:3, attributes:['Picking up Arcane Power orbs grants 250 overdrive','Casting a demon power while wielding a Tome grants <effect>Enraged</effect>'], unique:true, requires:'Tome'},
	...
	{name:'The Alchemist', rarity:'common', points:1, attributes:['Lower the cooldown of consumables by 10%'], unique:true},
	{name:'The Alchemist', rarity:'uncommon', points:3, attributes:['Lower the cooldown of consumables by 25%'], unique:true},
	{name:'The Alchemist', rarity:'rare', points:5, attributes:['Lower the cooldown of consumables by 40%'], unique:true},
	{name:'The Barbarian', rarity:'uncommon', points:5, attributes:['Lower attack cooldowns by 1 sec. when you overkill an enemy','Refresh all cooldowns when the overdrive bar is filled'], unique:true},
